...
//                                                                     //
//    Descrição:                                                       //
//   - O LED verde deverá ficar piscando com período de 500ms          //        
//     (250ms aceso e 250ms apagado).                                  //
//   - O LED vermelho deverá piscar (acender por 100ms e apagar) a     //
//     cada vez que o usuário digitar um número.                       //
//   - Caso o usuário pressione a tecla "*", o LED vermelho deverá     //
//     ficar acesso e o LED verde deve parar de piscar (apagado);      //
//   - Voltar ao funcionamento normal quando pressionado o sinal "+".  //
//                                                                     //
//   Obs.: Foi adicionado ao programa que a tecla 'k' possa fazer      //
//         o encerramento (kill) quando o programa estiver rodando,    //
//         ou seja, Led verde piscando. Para efeito de testes e        //
//         depuração e mantido na versão final.                        //
//                                                                     //
//*********************************************************************//
